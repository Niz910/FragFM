...
from casanovo.denovo.model_ssl import SpectrumSSL
...
def main():
    ...
    # Configuration
    # =====================================================
    train_mgf = "/nfs/turbo/umms-drjieliu/usr/kerryliu/proj_wjk/casanovo/sample_data/bacillus.10k.fixed.mgf"
